...
namespace TaviscaDataAnalyzerDatabase
{
    public class HotelSqlDatabase : IHotelRepository
    {
        ...
        public async Task<DataTable> GetAllLocationsDatabase()
        {
        ...
        public async Task<DataTable> HotelsAtALocationWithDatesDatabases(UIRequest queryFormat)
        {
        ...
        public async Task<DataTable> HotelNameWithDatesDatabases(UIRequest queryFormat)
        {
        ...
        public async Task<DataTable> TotalHotelBookingsDataBase()
        {
